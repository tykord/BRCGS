                ...
                Try {
                    ...
                    $Manufacturer = $Bios.Manufacturer
                        ...
                        If ($Manufacturer -eq "LENOVO") {
                                $ApiObject = Invoke-RestMethod -Uri "http://supportapi.lenovo.com/V2.5/Warranty?Serial=MJ09EQXH"
                            } else {
                        ...
                        foreach ($ID in $Notebook) {
                            ...
                            if ($EndDate -gt $Today) {
                                    $DaysRemaining = New-TimeSpan -Start $Today -End $EndDate | Select-Object -ExpandProperty Days
                            ...
                            $Object += New-Object -TypeName PSObject -Property $Properties | Select-Object ComputerName, Type, ID, StartDate, EndDate, DaysRemaining, Status
                        }
                    }
